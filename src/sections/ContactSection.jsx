...
const inputStyles =
  'w-full pb-2 px-0 bg-transparent text-gray-900 dark:text-gray-100 border-b-2 border-gray-400 dark:border-gray-600 focus:outline-none focus:border-indigo-600 transition-all duration-200 text-base';
    ...
    >
      <div className="container mx-auto px-4 text-center max-w-xl relative z-10">
        ...
        >
          ...
          <a
            href="mailto:parshuram7714@gmail.com"
            aria-label="Email Me"
        ...
        >
          <div>
            ...
            <input type="text" id="name" name="name" className={inputStyles} aria-label="Your Name" required />
          </div>
          ...
          <div>
            ...
            <input type="email" id="email" name="email" className={inputStyles} aria-label="Your Email" required />
          </div>
          ...
          <motion.button
            type="submit"
            className="w-full flex items-center justify-center px-6 py-3 bg-indigo-600 text-white font-bold text-lg rounded-md shadow-lg transition duration-300 transform hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
